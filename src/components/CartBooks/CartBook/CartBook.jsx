...
import { removeCartBooks } from "../../../utility/storage";
...
const CartBook = ({ book }) => {
  ...
  return (
    <div className="container mx-auto">
      <div className="flex flex-col lg:flex-row lg:justify-between gap-6 my-4 border border-[#13131326] rounded-2xl p-6 m-4 lg:mx-0">
        ...
        <div className="w-[100%] lg:w-[80%]">
          ...
          <div className="flex flex-col lg:flex-row w-[60%] lg:w-auto mx-auto lg:mx-0 border-t border-[#13131326] pt-[40px] lg:space-x-5 space-y-4 lg:space-y-0">
            ...
            <button
              onClick={() => removeCartBooks(bookId)}
              className="px-[20px] py-[11px] bg-[#f44343] rounded-[30px] text-[#fff] text-[18px] font-medium font-work-sans"
            >
              Remove From Cart
            </button>
          </div>
